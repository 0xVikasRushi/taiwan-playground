...
template CheckSubstrInclusionPoly(maxStrLen, maxSubstrLen) {
    ...
    signal str_poly_eval <== KZP_CalculateTotal(maxStrLen)(str_poly);
    signal substr_poly_eval <== KZP_CalculateTotal(maxSubstrLen)(substr_poly);
...
template ConcatenationCheck(maxFullStringLen, maxLeftStringLen, maxRightStringLen) {
    ...
    signal left_poly_eval <== KZP_CalculateTotal(maxLeftStringLen)(left_poly);
    signal right_poly_eval <== KZP_CalculateTotal(maxRightStringLen)(right_poly);
    signal full_poly_eval <== KZP_CalculateTotal(maxFullStringLen)(full_poly);
